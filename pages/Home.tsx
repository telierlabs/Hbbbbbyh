        ...
        {!categoryName && !isSearching && (
          <>
            ...
            <div style={{
              ...
              <div style={{ maxWidth: '600px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px' }}>
                <div>
                  <p style={{ ...mono, fontSize: '9px', letterSpacing: '0.3em', textTransform: 'uppercase', color: '#999', marginBottom: '16px', display: 'block' }}>
                    Cyberpunk Newsroom
                  </p>
                  <h1 style={{ ...m, fontSize: 'clamp(34px,9vw,62px)', fontWeight: 900, lineHeight: 0.95, letterSpacing: '-0.02em', color: '#000', margin: 0 }}>
