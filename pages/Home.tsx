  ...
  return (
    <>
          ...
          <>
            ...
            <div style={{ background: '#f5f5f7', backgroundImage: `linear-gradient(rgba(0,0,0,0.07) 1px,transparent 1px),linear-gradient(90deg,rgba(0,0,0,0.07) 1px,transparent 1px)`, backgroundSize: '40px 40px', paddingTop: '100px', paddingBottom: '16px', paddingLeft: '20px', paddingRight: '0', overflow: 'hidden' }}>
              <div style={{ maxWidth: '600px', margin: '0 auto', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
                ...
                {/* ✅ VR IMAGE WRAPPER dengan animasi shimmer kacamata */}
                <div style={{
                  position: 'relative',
                  flexShrink: 0,
                  ...
                  {/* Shimmer overlay — area kacamata (garis hijau ~27-40% dari atas gambar) */}
                  <div style={{
                    position: 'absolute',
                    top: '27%',
                    left: '8%',
                    ...
                    <div className="vr-shimmer" />
                  </div>

                  {/* Glow pulse di sekitar kacamata */}
                  <div style={{
                    position: 'absolute',
                    top: '24%',
                    left: '5%',
                    ...
                    pointerEvents: 'none',
                    borderRadius: '8px',
                    animation: 'vr-glow-pulse 2.8s ease-in-out infinite',
                    background: 'transparent',
                  }} className="vr-glow-wrap" />
                </div>
              </div>
            </div>
      ...
      <style>{`
        ...
        /* Shimmer bergerak kiri → kanan di area kacamata */
        @keyframes vr-scan {
        ...
        /* Glow pulse hijau di sekitar kacamata */
        @keyframes vr-glow-pulse {
          0%, 100% { box-shadow: 0 0 6px 2px rgba(0, 255, 80, 0.15); }
          50%       { box-shadow: 0 0 18px 6px rgba(0, 255, 80, 0.45); }
        }

        /* Shimmer beam — gradient hijau berjalan */
        .vr-shimmer {
          width: 42%;
          height: 100%;
          background: linear-gradient(
            90deg,
            transparent 0%,
            rgba(0, 255, 80, 0.08) 20%,
            rgba(0, 255, 100, 0.55) 48%,
            rgba(180, 255, 180, 0.75) 50%,
            rgba(0, 255, 100, 0.55) 52%,
            rgba(0, 255, 80, 0.08) 80%,
            transparent 100%
          );
          animation: vr-scan 2.6s ease-in-out infinite;
          border-radius: 4px;
          filter: blur(1px);
        }
        ...
        /* Glow pulse wrapper */
        .vr-glow-wrap {
          animation: vr-glow-pulse 2.6s ease-in-out infinite;
        }
