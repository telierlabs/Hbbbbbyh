            ...
            <div style={{ background: '#000', paddingBottom: '48px' }}>
              <div style={{ maxWidth: '600px', margin: '0 auto' }}>
                ...
                <div style={{
                  ...
                  <p style={{ color: '#444', fontSize: '11px', lineHeight: 1.7, paddingTop: '3px' }}>
                ...
                <div style={{
                  ...
                  {featureCards.map((card, i) => (
                    <div key={i} style={{
                      ...
                      <h3 style={{ ...montserrat, color: '#fff', fontSize: '11px', fontWeight: 700, marginBottom: '5px', lineHeight: 1.3 }}>
                        {card.title}
                      </h3>
                      <p style={{ color: '#4a4a4a', fontSize: '10px', lineHeight: 1.5 }}>
                        {card.desc}
                      </p>
                    </div>
                  ))}
