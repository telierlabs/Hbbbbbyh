...
const Home: React.FC<HomeProps> = ({ articles }) => {
  ...
  // Ambil 3 artikel pertama untuk kartu kecil horizontal scroll
  const smallCards = remainingArticles.slice(0, 3);
  const largeCards = remainingArticles.slice(3);

  return (
    <div style={{ background: '#000' }}>
      {!categoryName && (
        <>
          {/* HERO SECTION - Putih Bersih + Grid (HANYA HEADLINE) */}
          <div
            style={{
              background: '#ffffff',
              backgroundImage: `
          ...
          {/* DARK SECTION - DESKRIPSI + BUTTONS */}
          <div style={{
            background: '#000',
            paddingTop: '50px',
            paddingBottom: '50px',
          ...
          {/* HEADING SECTION - EXPLORE THE FUTURE */}
          <div style={{
            background: '#000',
            paddingTop: '40px',
            paddingBottom: '30px',
          ...
          {/* KARTU KECIL - HORIZONTAL SCROLL (3 ITEMS) */}
          {smallCards.length > 0 && (
            <div style={{
              background: '#000',
              paddingTop: '30px',
