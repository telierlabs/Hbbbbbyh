                ...
                <div style={{ padding: '16px 20px 0', marginTop: '-52px', position: 'relative', zIndex: 2 }}>
                  <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '16px' }}>
                      ...
                      {!subscribed ? (
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', paddingTop: '4px' }}>
                          <div style={{ width: '18px', height: '18px', borderRadius: '50%', background: '#1a1a1a', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                            <svg width="9" height="9" fill="none" stroke="#555" viewBox="0 0 24 24" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
                          </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', flexShrink: 0, textAlign: 'right', paddingTop: '2px' }}>
                      <div>
                        <span style={{ ...mono, fontSize: '18px', fontWeight: 700, color: '#fff', letterSpacing: '-0.02em', display: 'block', lineHeight: 1 }}>
                          {articles.length || '—'}
                        </span>
                        <span style={{ ...mono, fontSize: '7px', color: '#333', letterSpacing: '0.2em', textTransform: 'uppercase' }}>Artikel</span>
                      </div>
                      ...
                      <div>
                        ...
                        <span style={{ ...mono, fontSize: '7px', color: '#333', letterSpacing: '0.2em', textTransform: 'uppercase' }}>WIB</span>
                      </div>
                    </div>
