    ...
    <div style={{ background: '#000' }}>
      {!categoryName && (
        <>
          ...
          {/* 
            BATAS — persis foto 3:
            - Kiri bawah: hitam rata dari bawah kiri
            - Naik lurus sampai ~60% lebar
            - Lalu tonjolan rounded ke atas (seperti punuk/bahu) di kanan
            - Kanan atas: ujung di sudut kanan atas
          */}
            ...
            >
              <path
                d="
                  ...
                  L0,130
                  L820,130
                  C880,130 900,60 960,40
                  C1020,20 1060,10 1440,0
                  L1440,200
                  Z
                "
                fill="#000000"
