...
const SectionLabel: React.FC<{ label: string }> = ({ label }) => (
  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', margin: '20px 0 14px' }}>
    ...
    <span style={{ ...m, fontSize: '15px', letterSpacing: '0.08em', textTransform: 'uppercase', color: '#fff', whiteSpace: 'nowrap', fontWeight: 300 }}>
      {label}
    </span>
          ...
          <>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      {!subscribed ? (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', maxWidth: '260px' }}>
                          ...
                          <button onClick={handleSubscribe} style={{ width: 'fit-content', padding: '7px 14px', background: '#fff', color: '#000', border: 'none', borderRadius: '8px', fontSize: '11px', fontWeight: 700, cursor: 'pointer', fontFamily: "'Montserrat', sans-serif" }}>
                            Langganan
                          </button>
                        </div>
                      ) : (
            ...
            {trendingArticles.length > 0 && (
              <div style={{ background: '#000', paddingTop: '20px', paddingBottom: '20px', borderBottom: '1px solid #111' }}>
                <div style={{ maxWidth: '600px', margin: '0 auto', padding: '0 20px 12px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <span style={{ ...m, fontSize: '15px', letterSpacing: '0.08em', textTransform: 'uppercase', color: '#fff', fontWeight: 300 }}>Trending Sekarang</span>
                </div>
            ...
            <div style={{ background: '#000', paddingTop: '20px', paddingBottom: '20px', borderBottom: '1px solid #111' }}>
              <div style={{ maxWidth: '600px', margin: '0 auto', padding: '0 20px 12px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <span style={{ ...m, fontSize: '15px', letterSpacing: '0.08em', textTransform: 'uppercase', color: '#fff', fontWeight: 300 }}>Newsletter</span>
          ...
          <div style={{ maxWidth: '600px', margin: '0 auto', paddingTop: '24px' }}>
            ...
            {!categoryName && !isSearching && (
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '18px' }}>
                ...
                <span style={{ ...m, fontSize: '15px', letterSpacing: '0.08em', textTransform: 'uppercase', color: '#fff', whiteSpace: 'nowrap', fontWeight: 300 }}>Berita Terbaru</span>
                <div style={{ flex: 1, height: '1px', background: 'linear-gradient(90deg,#ffffff33,transparent)' }} />
              </div>
            )}
