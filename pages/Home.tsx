  ...
  return (
    <>
                      ...
                      return (
                        ...
                        >
                          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                            <div style={{ ...mono, fontSize: '24px', fontWeight: 900, color: '#8a8a8a', lineHeight: 1, flexShrink: 0, minWidth: '32px' }}>{String(idx+1).padStart(2,'0')}</div>
      ...
      <style>{`
        ...
        /* ===== CONTAINER — melebar bertahap sesuai layar ===== */
        .tn-container {
          max-width: 600px;
          margin: 0 auto;
        }
        @media (min-width: 768px) {
          .tn-container { max-width: 720px; }
        }
        @media (min-width: 1024px) {
          .tn-container { max-width: 960px; }
        }
        @media (min-width: 1280px) {
          .tn-container { max-width: 1180px; }
        }
        @media (min-width: 1600px) {
          .tn-container { max-width: 1360px; }
        }

        /* ===== HERO — lebih lega & gambar lebih besar di desktop ===== */
        @media (min-width: 1024px) {
          .tn-hero-bg { padding-top: 130px !important; padding-bottom: 32px !important; }
          .tn-hero-row { gap: 40px; align-items: center !important; }
          .tn-hero-title { font-size: 68px !important; }
          .tn-hero-img { height: 420px !important; }
        }
        @media (min-width: 1440px) {
          .tn-hero-bg { padding-top: 150px !important; padding-bottom: 40px !important; }
          .tn-hero-title { font-size: 82px !important; }
          .tn-hero-img { height: 480px !important; }
        }

        @media (min-width: 1024px) {
          .tn-stats-row { padding-left: 0 !important; padding-right: 0 !important; }
          .tn-explore-row { padding-left: 0 !important; padding-right: 0 !important; }
        }
        ...
        @media (min-width: 900px) {
          ...
          .tn-trending-card { width: 100% !important; }
        }
        @media (min-width: 1280px) {
        ...
        @media (min-width: 900px) {
          ...
          .tn-newsletter-card { width: 100% !important; }
        }
        @media (min-width: 1280px) {
