...
const updateOGTags = (article: NewsArticle) => {
  ...
  const existingSchema = document.getElementById('tn-news-schema');
...
const ChatFullscreen: React.FC<{ article: NewsArticle; fullText: string; onClose: () => void }> = ({ article, fullText, onClose }) => {
  ...
  return (
    <div
      ...
      onTouchEnd={e => { const dy = e.changedTouches[0].clientY - touchStartY.current; const dx = Math.abs(e.changedTouches[0].clientX - touchStartX.current); if (dy > 80 && dx < 60) onClose(); }}
    >
