...
/* Meteor: start kanan atas header → kiri bawah header */
...
/* Titik bintang hanya di area header */
const STARS = [
...
/* Meteor — start dari kanan atas, stagger rapat */
const METEORS = [
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: '#000',
        overflow: 'hidden',   /* penting: meteor tidak bocor keluar header */
      }}>

        {/* Titik bintang kedip pelan */}
        {STARS.map((s, i) => (
        ...
        {/* Meteor melesat kanan atas → kiri bawah */}
        {METEORS.map((m, i) => (
          <div key={`met${i}`} style={{
            position: 'absolute',
