      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100">
          ...
          <div className="mb-6">
            ...
            <h1 className="text-3xl font-bold mb-2 tracking-tight">Login TelierNews</h1>
            <p className="text-gray-500 text-sm">Akses fitur langganan dan simpan artikel favorit</p>
          </div>
          ...
          <div className="mt-6 p-4 bg-slate-50 rounded-xl text-center">
            <p className="text-sm text-gray-600">
              Belum punya akun? <button className="font-bold text-black hover:underline">Daftar Sekarang</button>
            </p>
          </div>
