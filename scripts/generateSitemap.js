...
// Firebase config dari services/firebase.ts lo
...
async function generateSitemap() {
  try {
    ...
    // Sama persis kayak articleService.ts lo
...
${articles.map(article => `
  <url>
    <loc>https://teliernews.com/news/${article.id}</loc>
