...
const Header: React.FC<HeaderProps> = ({ onMenuToggle, onSearch }) => {
  ...
  // ✅ Load bookmarks — Firebase jika login, localStorage jika tidak
  ...
  // ✅ Auth state — saat login, subscribe realtime bookmarks dari Firebase
  useEffect(() => {
  ...
  // ✅ Sync saat event localStorage (untuk user belum login)
  useEffect(() => {
          ...
          >
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                {/* Badge login status */}
                {isLoggedIn ? (
                  <span style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '8px', color: '#4ade80', letterSpacing: '0.1em', border: '1px solid #4ade8033', padding: '2px 6px', borderRadius: '4px' }}>
                    ● FIREBASE
                  </span>
                ) : (
                  <span style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '8px', color: '#888', letterSpacing: '0.1em', border: '1px solid #222', padding: '2px 6px', borderRadius: '4px' }}>
                    LOCAL
                  </span>
                )}
              </div>
