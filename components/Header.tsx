...
const Header: React.FC<HeaderProps> = ({ onMenuToggle, onSearch }) => {
  ...
  // ✅ FIX: Hapus focusMode, hanya pakai nightMode
  ...
  // ✅ FIX: Hapus useEffect focusMode, hanya pakai nightMode
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* ✅ FIX: Hanya tombol night mode, hapus focus mode, posisi bottom fix */}
      {isNewsDetail && (
        <div style={{
          position: 'fixed', bottom: '80px', right: '20px',
          zIndex: 41, display: 'flex', flexDirection: 'column', gap: '8px'
        }}>
          <button
