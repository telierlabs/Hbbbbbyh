...
const ArticleChat: React.FC<ArticleChatProps> = ({ articleTitle, articleContent }) => {
  ...
  // FIX: Hanya scroll di dalam container chat, bukan scroll halaman
  useEffect(() => {
  ...
  return (
    <>
      <div className="mt-10 pt-8 border-t border-gray-100">
        ...
        {/* FIX: ref dipindah ke container div, bukan messagesEndRef */}
        <div ref={chatContainerRef} className="space-y-4 pb-28">
          {messages.length === 0 ? (
          ...
          {/* FIX: messagesEndRef dihapus, tidak perlu lagi */}
        </div>
      </div>
