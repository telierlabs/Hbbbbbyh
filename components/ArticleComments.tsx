  ...
  return (
    <div style={{ marginTop: '40px', paddingTop: '32px', borderTop: '1px solid #f0f0f0' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '24px' }}>
        ...
        {comments.length > 0 && (
          <span style={{
            fontFamily: "'Share Tech Mono', monospace", fontSize: '8px', color: '#aaa',
            background: '#f5f5f5', padding: '2px 8px', borderRadius: '20px',
          }}>
            {comments.length}
          </span>
        )}
      ...
      {comments.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '24px 0', marginBottom: '24px' }}>
          <p style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '10px', color: '#ccc', letterSpacing: '0.2em' }}>
            BELUM ADA KOMENTAR
          </p>
          <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: '12px', color: '#bbb', marginTop: '6px' }}>
        ...
        <div style={{ background: '#f8f8f8', borderRadius: '16px', padding: '16px', border: '1px solid #eee' }}>
          {!isLoggedIn && (
            <input
              ...
              style={{
                ...
                padding: '0 0 10px', marginBottom: '12px',
          ...
          <textarea
            ...
            style={{
              ...
              resize: 'none', fontSize: '13px', color: '#333', outline: 'none',
              fontFamily: "'Montserrat', sans-serif", lineHeight: 1.6,
            }}
          />
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '10px' }}>
            <span style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '8px', color: '#ccc' }}>
              {text.length}/500
            </span>
