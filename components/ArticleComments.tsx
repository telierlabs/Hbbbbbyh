...
const ArticleComments: React.FC<ArticleCommentsProps> = ({ articleId }) => {
  ...
  // Cek apakah user bisa hapus komentar ini
  // User bisa hapus kalau: komentar miliknya (uid sama) ATAU admin (bisa ditambah logika admin nanti)
  const canDelete = (c: Comment) => {
    if (!currentUid) return false;
    return c.uid === currentUid;
  };
